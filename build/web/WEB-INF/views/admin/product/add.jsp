                            ...
                            <form method="post" 
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        <label>Name</label>
                                        <input name="name" type="text" value="${param.name}" class="form-control" required>
                                    </div>
                                    <div class="form-group">
                                        <label>Image</label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="quantity" type="number" value="${param.quantity}" class="form-control" required>
                                    </div>
                                    <p style="color: red">
                                    ...
                                    <div class="form-group">
                                        <label>Price</label>
                                        <input name="price" type="text" value="${param.price}" class="form-control" required>
                                    </div>
                                    <p style="color: red">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="category" class="form-select" aria-label="Default select example">
                                            <c:forEach items="${requestScope.clist}" var="c">
                                                <option value="${c.id}" ${p.cate.id == param.category ?"selected='selected'":"" }>${c.name}</option>
                                            </c:forEach>
                                        </select>
                                    </div>
